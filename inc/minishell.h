...
char				*process_regular_char(char *content, char *result, int *i, \
						struct s_gc **garbage);
char				*process_valid_variable(char *content, char *result, \
						t_sys *sys, int *i);
char				*process_invalid_variable(char *content, char *result, \
						int *i, struct s_gc **garbage);
...
void				expand_quoted_str(char **str, t_sys *sys, int exit_status,
						int is_single);
void				expand_variable_str(char **str, t_sys *sys, \
						int exit_status);
...
void				handle_redirection(char *line, int *i, t_type **lst, \
						t_sys *sys);
char				*extract_quoted_redir_content(char *line, int *i, \
						char quote, t_sys *sys);
...
char				*extract_quoted_arg(char *line, int *i, char quote, \
						t_sys *sys);
